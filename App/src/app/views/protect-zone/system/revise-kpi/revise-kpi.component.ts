...
@Component({
  selector: 'app-revise-kpi',
  templateUrl: './revise-kpi.component.html',
  styleUrls: ['./revise-kpi.component.scss'],
  providers: [DatePipe]
})
export class ReviseKpiComponent implements OnInit {
  ...
  getKPIAsTreeView() {
    this.spinner.show()
    const lang = localStorage.getItem('lang');
    this.kpiNewService.getTree2nd3rd(lang,this.userId).subscribe((res: any) => {
