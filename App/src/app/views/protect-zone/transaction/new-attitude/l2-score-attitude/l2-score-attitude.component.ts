...
@Component({
  selector: 'app-l2-score-attitude',
  templateUrl: './l2-score-attitude.component.html',
  styleUrls: ['./l2-score-attitude.component.scss']
})
export class L2ScoreAttitudeComponent implements OnInit {
  ...
  getNewAttitudeSubmit() {
    this.service.getNewAttitudeSubmit(this.campaignID, this.scoreTo).subscribe((res :any) => {
      if (res !== null) {
        this.submitCheck = res.isSubmitAttitudeL2
      }
    })
  }
