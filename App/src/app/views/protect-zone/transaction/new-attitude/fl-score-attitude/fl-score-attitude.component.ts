...
@Component({
  selector: 'app-fl-score-attitude',
  templateUrl: './fl-score-attitude.component.html',
  styleUrls: ['./fl-score-attitude.component.scss']
})
export class FlScoreAttitudeComponent implements OnInit {
  ...
  getNewAttitudeSubmit() {
    this.service.getNewAttitudeSubmit(this.campaignID, this.scoreTo).subscribe((res :any) => {
      if (res !== null) {
        this.submitCheck = res.isSubmitAttitudeFL
      }
    })
  }
