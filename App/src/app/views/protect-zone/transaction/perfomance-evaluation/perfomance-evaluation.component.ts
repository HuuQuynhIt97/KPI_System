...
@Component({
  selector: 'app-perfomance-evaluation',
  templateUrl: './perfomance-evaluation.component.html',
  styleUrls: ['./perfomance-evaluation.component.scss'],
  providers: [ToolbarService, EditService, PageService,DatePipe]
})
export class PerfomanceEvaluationComponent extends BaseComponent implements OnInit {
  ...
  SelfScore(data) {
    if(data.isGM) {
      ...
      window.open(`#${this.router.url}/self-score/${data.type}/${data.campaignID}/${data.userID}`,'_blank')
    }
  }
  ...
  getSelfAppraisal(){
    ...
    //   this.evaluationService.getSelfAppraisal(this.userId).subscribe(
    //     (result: any) => {
  ...
  getFirstLevelAppraisal(){
    // return new Promise((res, rej) => {
    //   this.evaluationService.getFirstLevelAppraisal(this.userId).subscribe(
    //     (result: any) => {
  ...
  getSecondLevelAppraisal(){
    // return new Promise((res, rej) => {
    //   this.evaluationService.getSecondLevelAppraisal(this.userId).subscribe(
    //     (result: any) => {
  ...
  getFLFeedback(){
    // return new Promise((res, rej) => {
    //   this.evaluationService.getFLFeedback(this.userId).subscribe(
    //     (result: any) => {
