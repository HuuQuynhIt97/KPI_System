...
import { HqReportModalComponent } from './hq-report-modal/hq-report-modal.component';

@Component({
  selector: 'app-hq-report',
  templateUrl: './hq-report.component.html',
  styleUrls: ['./hq-report.component.scss'],
...
export class HqReportComponent implements OnInit {
  ...
  openDetail(data) {
    const modalRef = this.modalService.open(HqReportModalComponent, { size: 'xxl', backdrop: 'static', keyboard: false });
