...
namespace A4KPI.Constants
{
    public static class MessageReponse
    {
        ...
        public static string L0Success = "Chọn L0 thành công";
        public static string UnL0Success = "Bỏ chọn L0 thành công";

        public static string GhrSuccess = "Chọn GHR thành công";
        public static string UnGhrSuccess = "Bỏ chọn GHR thành công";
